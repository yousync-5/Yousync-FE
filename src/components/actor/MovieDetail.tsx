...
export const MovieDetail: React.FC<VideoDetailProps> = ({movie}) => {
    ...
    const handleDubbingClick = () => {
        router.push(`/dubbing/${movie.id}?modalId=${movie.youtube_url}`);
      };
  ...
  return (
    ...
    >
        ...
        <div className="flex justify-end">
            ...
            className="px-4 py-2 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 text-white rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
                더빙하기
            </button>
        </div>
    </div>
